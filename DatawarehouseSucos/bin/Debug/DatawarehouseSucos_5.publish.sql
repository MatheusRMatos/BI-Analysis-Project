...
GO
PRINT N'Rename refactoring operation with key 8ba5fab4-2e14-42ee-b359-41b0a505b3dd is skipped, element [dbo].[Fato_001].[Id] (SqlSimpleColumn) will not be renamed to Cod_Cliente';


GO
PRINT N'Rename refactoring operation with key 25429a75-5991-40e5-b024-e1d1f704e5c2, 2b9f2288-ccdd-473c-b400-9b20c7b23c7b is skipped, element [dbo].[Fato_001].[Custo_] (SqlSimpleColumn) will not be renamed to Quantidade_Vendida';
